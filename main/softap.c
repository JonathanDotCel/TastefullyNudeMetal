...
//
//It's just the example from the idf folder
//
...
#define EXAMPLE_ESP_WIFI_SSID "BLIP BLOOP"  // might or might not be my actual wifi
#define EXAMPLE_ESP_WIFI_PASS "0000000000"      // is deff my actual wifi pass
